...
p1 = ax1.pcolor(W_1, W_2, np.log10(Z), cmap="RdBu_r", zorder=0, vmin=-4, vmax=-1)
...
print(np.log10(Z).min(), np.log10(Z).max())
p2 = ax2.pcolor(W_1, W_2, np.log10(Z), cmap="RdBu_r", zorder=0, vmin=-4, vmax=-1)

ax2.set_xlabel(r"$\theta_1$", fontsize=12)
ax2.set_aspect("equal", "box")

ax2.scatter(w_star[0], w_star[1], color="k", s=5, zorder=10)
ax2.scatter(w_star[0], -w_star[1], color="k", s=5, zorder=10)
ax2.scatter(-w_star[0], w_star[1], color="k", s=5, zorder=10)
ax2.scatter(-w_star[0], -w_star[1], color="k", s=5, zorder=10)
